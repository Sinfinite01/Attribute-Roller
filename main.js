...
// from: https://dev.to/codebubb/hot-to-shuffle-an-array-injavascript-2ikj
// adapted to JS and reconfigured to retirn a new (non-mutated) array
...
function sumArrayElements(array) {
    ...
    return sum;
    // or return array.reduce((total, currentNumber) => total + currentNumber);
}
